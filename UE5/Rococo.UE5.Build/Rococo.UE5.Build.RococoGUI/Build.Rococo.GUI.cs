...
namespace Rococo
{
    ...
    internal class RococoGUIBuilder
    {
        ...
        {
            string ultraDirectory = MakePluginSourceFolder("RococoGuiUltra");
            ...
            CreateBundleDirect(ultraDirectory, "wrap.s-parser.cpp", "rococo.UE5.h", "rococo.UE5.prelude.h", "rococo.UE5.postlude.h", "rococo/sexy/SP/sexy.s-parser",
                new List<string>()
                {
                      "sexy.s-parser.cpp",
                      "sexy.s-builder.cpp",
            ...
            CreateBundleDirect(ultraDirectory, "wrap.s-utils.cpp", "rococo.UE5.h", null, null, "rococo/sexy/Utilities",
                new List<string>()
                {
                    "sexy.util.cpp"
                }
            ...
            CreateBundleDirect(ultraDirectory, "wrap.sexml.cpp", "rococo.UE5.h", null, null, "rococo/rococo.sexml",
                new List<string>()
                {
            ...
            CreateBundleDirect(ultraDirectory, "wrap.maths.cpp", "rococo.UE5.h", null, null, "rococo/rococo.maths",
                new List<string>()
                {
            ...
            CreateBundleDirect(ultraDirectory, "wrap.greatsex.cpp", "rococo.UE5.h", null, null, "rococo/rococo.great.sex",
                new List<string>()
                {
            ...
            CreateSeparateFilesDirect(ultraDirectory, "wrap.", "rococo.tiff.UE5.h", "rococo.tiff.prelude.decl.h", "rococo.tiff.postlude.h", Path.Join("3rd-Party", "libtiff"),
                new List<string>()
                {
                    "bloke.tiff.cpp"
                }
            ...
            CreateSeparateFilesDirect(ultraDirectory, "wrap.", "rococo.jpg.UE5.h", "rococo.jpg.prelude.decl.h", "rococo.jpg.postlude.h", "3rd-Party/libjpg/",
                new List<string>()
                {
                    "readimage.cpp",
                    "writeimage.cpp"
            ...
            CopyFileToSource(ultraDirectory, "RococoOS", "rococo.OS.UE5.cpp");
            CopyFileToSource(ultraDirectory, "RococoUtil", "RococoBP_Util_Lib.cpp");
            CopyFileToSource(ultraDirectory, "RococoGui", "GameOptionBuilder.cpp");
            CopyFileToSource(ultraDirectory, "RococoGui", "ReflectedGameOptionsBuilder.cpp");
            CopyFileToSource(ultraDirectory, "RococoGui", "RococoFontSet.cpp");
            CopyFileToSource(ultraDirectory, "RococoGui", "RococoGRHostWidget.cpp");
            CopyFileToSource(ultraDirectory, "RococoGui", "RococoGui_BPEvents.cpp");
            CopyFileToSource(ultraDirectory, "RococoGui", "SRococoGRHostWidget.cpp");
            CopyFileToSource(ultraDirectory, "RococoGui", "UE5.GR.EventMarhsalling.cpp");
            CopyFileToSource(ultraDirectory, "RococoGui", "UE5.GR.EventMarhsalling.h");
            CopyFileToSource(ultraDirectory, "RococoGui", "UE5.GR-Custodian.cpp");

            CopyFileToHeader(ultraHeaderDirectory, "RococoUtil", "RococoBP_Util_Lib.h");
            CopyFileToHeader(ultraHeaderDirectory, "RococoGui", "GameOptionBuilder.h");
            CopyFileToHeader(ultraHeaderDirectory, "RococoGui", "ReflectedGameOptionsBuilder.h");
            CopyFileToHeader(ultraHeaderDirectory, "RococoGui", "RococoFontSet.h");
            CopyFileToHeader(ultraHeaderDirectory, "RococoGui", "RococoGRHostWidget.h");
            CopyFileToHeader(ultraHeaderDirectory, "RococoGui", "RococoGui_BPEvents.h");
            CopyFileToHeader(ultraHeaderDirectory, "RococoGui", "RococoGuiAPI.h");
            CopyFileToHeader(ultraHeaderDirectory, "RococoGui", "SlateRenderContext.h");
            CopyFileToHeader(ultraHeaderDirectory, "RococoGui", "SRococoGRHostWidget.h");
        } // RococoGuiUltra

        private void CopyFileToHeader(string sourceDirectory, string pluginName, string filename)
        {
            ...
            StringBuilder sb = new StringBuilder();
            sb.AppendLine(string.Format("// Generated by Build.Rococo.GUI.cs. Copied from {0} at {1} UTC", sourceFile, DateTime.UtcNow.ToString("MMM yyyy")));
            sb.AppendLine();
            sb.AppendFormat("#include \"{0}\"", sourceFile);

            WriteUpdated(sb, targetFile);
        }

        private void CopyFileToSource(string sourceDirectory, string pluginName, string filename)
        {
            string targetFile = Path.Join(sourceDirectory, filename);
