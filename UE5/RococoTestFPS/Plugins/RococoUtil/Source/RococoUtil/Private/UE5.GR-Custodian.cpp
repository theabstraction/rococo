...
namespace Rococo::Gui::UE5::Implementation
{
	...
	struct UE5_GR_Renderer : IGRRenderContext
	{
		...
		UE5Custodian& custodian;

		UE5_GR_Renderer(UE5Custodian& _custodian) : custodian(_custodian)
		{
	...
	*/
	...
	struct UE5_GR_Custodian : IUE5_GR_CustodianSupervisor, IGRCustodian, IGREventHistory, IGRFonts, IGRImages, Windows::IWindow
	{
