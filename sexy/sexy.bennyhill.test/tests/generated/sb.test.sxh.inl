...
namespace
{
	...
	void NativeGetHandleForSysAnimalsGetTigerByName(NativeCallEnvironment& _nce)
	{
		...
		Sys::Animals::ITiger* nceContext = reinterpret_cast<Sys::Animals::ITiger*>(_nce.context);
		// Uses: Sys::Animals::ITiger* FactoryConstructSysAnimalsGetTigerByName(Sys::Animals::ITiger* _context, const fstring& _tigerName);
