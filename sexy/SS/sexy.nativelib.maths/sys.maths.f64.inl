...
namespace Sys { namespace Maths { namespace F64 { 
	void AddNativeCalls_SysMathsF64(Rococo::Script::IPublicScriptSystem& ss, void* nullContext = nullptr)
	{
		...
		ss.AddNativeCall(ns, NativeSysMathsF64ArcSin, nullptr, ("ArcSin(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64ArcCos, nullptr, ("ArcCos(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64ArcTan, nullptr, ("ArcTan(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64ArcTanYX, nullptr, ("ArcTanYX(Float64 y)(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64Abs, nullptr, ("Abs(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64Sinh, nullptr, ("Sinh(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64Cosh, nullptr, ("Cosh(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64Tanh, nullptr, ("Tanh(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64Exp, nullptr, ("Exp(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64Floor, nullptr, ("Floor(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64Ceiling, nullptr, ("Ceiling(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64Power, nullptr, ("Power(Float64 base)(Float64 exponent) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64LogN, nullptr, ("LogN(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64Log10, nullptr, ("Log10(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64SquareRoot, nullptr, ("SquareRoot(Float64 x) -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64ErrorFunction, nullptr, ("ErrorFunction(Float64 x) -> (Float64 y)"));
		ss.AddNativeCall(ns, NativeSysMathsF64MaxOf, nullptr, ("MaxOf(Float64 x)(Float64 y) -> (Float64 maxValue)"));
		ss.AddNativeCall(ns, NativeSysMathsF64MinOf, nullptr, ("MinOf(Float64 x)(Float64 y) -> (Float64 minValue)"));
		ss.AddNativeCall(ns, NativeSysMathsF64RoundToNearest, nullptr, ("RoundToNearest(Float64 x) -> (Float64 y)"));
		ss.AddNativeCall(ns, NativeSysMathsF64IsInfinity, nullptr, ("IsInfinity(Float64 x) -> (Bool isInfinity)"));
		ss.AddNativeCall(ns, NativeSysMathsF64IsNan, nullptr, ("IsNan(Float64 x) -> (Bool isNan)"));
		ss.AddNativeCall(ns, NativeSysMathsF64IsSignalNan, nullptr, ("IsSignalNan(Float64 x) -> (Bool isNan)"));
		ss.AddNativeCall(ns, NativeSysMathsF64IsQuietNan, nullptr, ("IsQuietNan(Float64 x) -> (Bool isNan)"));
		ss.AddNativeCall(ns, NativeSysMathsF64IsNormal, nullptr, ("IsNormal(Float64 x) -> (Bool isNormal)"));
		ss.AddNativeCall(ns, NativeSysMathsF64IsFinite, nullptr, ("IsFinite(Float64 x) -> (Bool isFinite)"));
		ss.AddNativeCall(ns, NativeSysMathsF64QuietNan, nullptr, ("QuietNan -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64MinValue, nullptr, ("MinValue -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64MaxValue, nullptr, ("MaxValue -> (Float64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64ToInt32, nullptr, ("ToInt32(Float64 x) -> (Int32 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64ToInt64, nullptr, ("ToInt64(Float64 x) -> (Int64 value)"));
		ss.AddNativeCall(ns, NativeSysMathsF64ToFloat32, nullptr, ("ToFloat32(Float64 x) -> (Float32 value)"));
	}
}}}