...
$(OBJ_DIR)sexy.nativelib.coroutines.obj : $(REFL_DIR)sexy.nativelib.coroutines.cpp
	$(CPP_COMPILER) $(CPP_FLAGS) -c $< -o $@
	
clean:
	rm -f $(BIN_DIR)sexy.nativelib.coroutines.mac.dylib $(OBJ_DIR)sexy.nativelib.coroutines.obj
