...
namespace
{
	...
	void NativeDystopiaIJournalAddGoalMeet(NativeCallEnvironment& _nce)
	{
		...
		ReadInput(_pObject, _sf, -_offset);
		ID_GOAL id = _pObject->AddGoalMeet(title, body, a, b, radius, completionFunction);
		_offset += sizeof(id);
...
namespace
{
	...
	void NativeDystopiaILevelBuilderAddEnemy(NativeCallEnvironment& _nce)
	{
		...
		ReadInput(_pObject, _sf, -_offset);
		ID_ENTITY entityId = _pObject->AddEnemy(*pos, editorId);
	...
	void NativeDystopiaILevelBuilderAddAlly(NativeCallEnvironment& _nce)
	{
		...
		ReadInput(_pObject, _sf, -_offset);
		ID_ENTITY entityId = _pObject->AddAlly(*pos, editorId);
		_offset += sizeof(entityId);
		WriteOutput(entityId, _sf, -_offset);
	}
	void NativeDystopiaILevelBuilderAddAmmunition(NativeCallEnvironment& _nce)
	{
		...
		ReadInput(_pObject, _sf, -_offset);
		ID_ENTITY entityId = _pObject->AddAmmunition(*pos, editorId, name, imageFile, ammoType, massPerBullet, massPerClip, count);
		_offset += sizeof(entityId);
		WriteOutput(entityId, _sf, -_offset);
	}
	void NativeDystopiaILevelBuilderAddRangedWeapon(NativeCallEnvironment& _nce)
	{
		...
		ReadInput(_pObject, _sf, -_offset);
		ID_ENTITY entityId = _pObject->AddRangedWeapon(*pos, editorId, name, imageFile, muzzleVelocity, flightTime, ammoType, massKg);
		_offset += sizeof(entityId);
		WriteOutput(entityId, _sf, -_offset);
	}
	void NativeDystopiaILevelBuilderAddArmour(NativeCallEnvironment& _nce)
	{
		...
		ReadInput(_pObject, _sf, -_offset);
		ID_ENTITY entityId = _pObject->AddArmour(*pos, editorId, name, imageFile, bulletProt, dollSlot, massKg);
		_offset += sizeof(entityId);
		WriteOutput(entityId, _sf, -_offset);
	}
	void NativeDystopiaILevelBuilderAddSolid(NativeCallEnvironment& _nce)
	{
		...
		ReadInput(_pObject, _sf, -_offset);
		ID_ENTITY entityId = _pObject->AddSolid(*pos, editorId, flags);
		_offset += sizeof(entityId);
		WriteOutput(entityId, _sf, -_offset);
	}
