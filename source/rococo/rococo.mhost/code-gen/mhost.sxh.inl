...
// Generated by BennyHill on 01/08/2023 10:30:32 UTC
...
namespace MHost
{
	void AddNativeCalls_MHostIGui(Rococo::Script::IPublicScriptSystem& ss, MHost::IGui* _nceContext)
	{
		...
		ss.AddNativeCall(ns, NativeMHostIGuiEvalTextSpan, nullptr, ("IGuiEvalTextSpan (Pointer hObject)(Sys.Type.IString text)(Int32 fontIndex)(Sys.Maths.Vec2 pixelSpan) -> "), __FILE__, __LINE__);
...
namespace
{
	...
	void NativeGetHandleForMHostDictionaryStream(NativeCallEnvironment& _nce)
	{
		...
		// Uses: MHost::IDictionaryStream* FactoryConstructMHostDictionaryStream(Rococo::IO::IInstallation* _context);
