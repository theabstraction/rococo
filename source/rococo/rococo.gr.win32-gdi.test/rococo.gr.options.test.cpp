...
struct GraphicsOptions: IGameOptions
{
	...
	void GetFullscreenResolution(IChoiceInquiry& inquiry)
	{
		...
		inquiry.AddChoice("1920x1080", "1920 x 1080 60Hz");
		inquiry.AddChoice("1920x1200", "1920 x 1200 60Hz");
		inquiry.AddChoice("2560x1536", "2560 x 1536 60Hz");
		inquiry.AddChoice("3840x2160", "3840 x 2160 60Hz");
		inquiry.AddChoice("1366x768", "1366 x 768 60Hz");
		inquiry.AddChoice("1280x1024", "1280 x 1024 60Hz");
		inquiry.AddChoice("1024x768", "1024 x 768 60Hz");
		inquiry.AddChoice("800x600", "800 x 600 60Hz");
		inquiry.AddChoice("640x480", "640 x 480 60Hz");
		inquiry.AddChoice("1920x1080", "1920 x 1080 144Hz");
		inquiry.AddChoice("1920x1200", "1920 x 1200 144Hz");
		inquiry.AddChoice("2560x1536", "2560 x 1536 144Hz");
		inquiry.AddChoice("3840x2160", "3840 x 2160 144Hz");
		inquiry.AddChoice("1366x768", "1366 x 768 144Hz");
		inquiry.AddChoice("1280x1024", "1280 x 1024 144Hz");
		inquiry.AddChoice("1024x768", "1024 x 768 144Hz");
		inquiry.AddChoice("800x600", "800 x 600 144Hz");
		inquiry.AddChoice("640x480", "640 x 480 144Hz");
		inquiry.AddChoice("1920x1080", "1920 x 1080 200Hz");
		inquiry.AddChoice("1920x1200", "1920 x 1200 200Hz");
		inquiry.AddChoice("2560x1536", "2560 x 1536 200Hz");
		inquiry.AddChoice("3840x2160", "3840 x 2160 200Hz");
		inquiry.AddChoice("1366x768", "1366 x 768 200Hz");
		inquiry.AddChoice("1280x1024", "1280 x 1024 200Hz");
		inquiry.AddChoice("1024x768", "1024 x 768 200Hz");
		inquiry.AddChoice("800x600", "800 x 600 200Hz");
		inquiry.AddChoice("640x480", "640 x 480 200Hz");
