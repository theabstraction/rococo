...
// Rococo.DirectXmath.h takes the original file from Micosoft and replaces #include "sal.h" with "rococo.sal.h" - the aim is to reduce naming conflicts
// while compiling Rococo for Unreal Engine
...
#include "rococo.sal.h" // Modified from the original file by Microsoft
#include <assert.h>
