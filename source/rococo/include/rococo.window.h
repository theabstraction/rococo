...
namespace Rococo
{
	...
	namespace Windows
	{
		...
		ROCOCO_WINDOWS_API IWin32SuperComboBox* AddSuperComboBox(IWindow& parent, ISuperListSpec& spec, const GuiRect& rect, cstr name, ControlId id, DWORD style, DWORD styleEx = 0);
