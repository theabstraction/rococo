...
namespace
{
   struct Sprites : public ISpriteBuilderSupervisor
   {
      ...
      void Clear()
      {
         renderer.GuiResources().SpriteBuilder().Clear();
         names.clear();
      }
      ...
      void AddSprite(const fstring& resourceName)
      {
         ...
         if (Eq(ext, ".tif") || Eq(ext, ".tiff") || Eq(ext, ".jpg") || Eq(ext, ".jpeg"))
         {
            ...
            {
               renderer.GuiResources().SpriteBuilder().AddBitmap(resourceName);
      ...
      void LoadAllSprites()
      {
         renderer.GuiResources().SpriteBuilder().BuildBitmaps(256);
      }
