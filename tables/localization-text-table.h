#pragma once
// Generated by rococo.carpenter. Timestamp: 29 September 2022 21:34:30// Excel Source: C:\work\rococo\tables\XL\localization-text-table.xlsx
...
namespace Rococo::Strings
{
    ROCOCO_INTERFACE ILocalizedText_MetaData
    {
        virtual fstring GetTitle() const = 0;
        virtual fstring GetOwner() const = 0;
    };

    ROCOCO_INTERFACE ILocalizedText
    {
