// Generated by rococo.carpenter. Timestamp: 21/05/2022 18:29:50
...
static void AppendPeriodicTable_Rows(std::vector<PeriodicTable_Row>& rows, const IInstallation& installation, const char* source)
{
    ...
    struct ANON : ITableRowBuilder
    {
        ...
        std::vector<PeriodicTable_Row>* rows = nullptr;
...
namespace ANON
{
    ...
    {
        std::vector<PeriodicTable_Row> rows;
        ...
        {
            rows.clear();
            AppendPeriodicTable_Rows(rows, installation, tablePingPath);
        }
