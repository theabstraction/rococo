#pragma once
// Generated by rococo.carpenter. Timestamp: 18 September 2022 11:15:28// Excel Source: C:\work\rococo\tables\XL\quotes-table.xlsx
...
namespace Rococo::Quotes
{
    ...
    bool AppendString(QuoteId value, Strings::IStringPopulator& populator);
...
namespace Rococo::Quotes
{
    ...
    ROCOCO_INTERFACE IQuotesSupervisor: IQuotes
    {
        virtual void Free() = 0;
    };
