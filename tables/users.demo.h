#pragma once
// Generated by rococo.carpenter. Timestamp: 10/04/2022 21:30:06
...
namespace Rococo::Test::UserDemo
{
    ...
    ROCOCOAPI IUsers
    {
        ...
        virtual const IUsers_Row* FindRowByOwnerId(fstring ownerId) const = 0;
        virtual const IUsers_Row* FindRowByPurchaseId(int64 purchaseId) const = 0;
    };
