// Generated by rococo.carpenter. Timestamp: 04/07/2022 18:54:10
...
namespace ANON
{
    ...
    {
        Rococo::Strings::ILocalizedText_Sexy& GetSexyInterface()
        {
            return *this;
        }
        ...
        void GetRow(int32 index, struct LocalizedTextRowSexy& row) override
        {
            ...
            const auto& rawRow = GetRow(index);
            row.id = rawRow.id;
            Rococo::Script::PopulateStringBuilder(row.english, rawRow.english);
            Rococo::Script::PopulateStringBuilder(row.german, rawRow.german);
        }
